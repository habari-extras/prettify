...
// Modified from Google's source to auto-load prettify asyncronously as a 
// Habari lib.
...
(function () {
  ...
  for (var i = 0, n = langs.length; i < n; ++i) (function (lang) {
    ...
    script.src = LOADER_BASE_URL
       + '/lib/prettify/lang-' + encodeURIComponent(langs[i]) + '.js';
  ...
  for (var i = 0, n = skins.length; i < n; ++i) {
    skinUrls.push(LOADER_BASE_URL
        + '/css/skins/' + encodeURIComponent(skins[i]) + '.css');
  }
